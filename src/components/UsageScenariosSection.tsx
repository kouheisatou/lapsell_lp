...
export function UsageScenariosSection() {
  ...
  const scenarios = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1589330694653-ded6df03f754?w=800&auto=format&fit=crop',
      imageAlt: '名刺とフライヤーにQRコードが印刷されている様子',
    },
    {
      icon: Share2,
      title: 'SNSプロフィール・リンクツリーに常設',
      description: 'InstagramやTwitterのプロフィールにQRコードリンクを固定。フォロワーがいつでも購入できる導線を確保し、ストーリーズでも定期的にシェア。デジタル時代の常設ギャラリーとして機能します。',
      image: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&auto=format&fit=crop',
      imageAlt: 'SNSプロフィール画面とリンクツリー',
    },
    {
      icon: Crown,
